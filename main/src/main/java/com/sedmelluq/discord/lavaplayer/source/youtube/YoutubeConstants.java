...
public class YoutubeConstants {
    ...
    static final String CLIENT_ANDROID_VERSION = "16.37";
    ...
    static final String EMBED_PART_PAYLOAD = ",\"clientScreen\":\"" + CLIENT_SCREEN_EMBED
    ...
    static final String SEARCH_PAYLOAD = DEFAULT_BASE_PAYLOAD + SCREEN_PART_PAYLOAD + CLOSE_BASE_PAYLOAD
            + "\"query\":\"%s\",\"params\":\"EgIQAQ==\"}";
    static final String PLAYER_URL = BASE_URL + "/player";
    static final String PLAYER_PAYLOAD = DEFAULT_BASE_PAYLOAD + SCREEN_PART_PAYLOAD + CLOSE_BASE_PAYLOAD
            + CLOSE_PLAYER_PAYLOAD;
    static final String PLAYER_EMBED_PAYLOAD = DEFAULT_BASE_PAYLOAD + SCREEN_PART_PAYLOAD + EMBED_PART_PAYLOAD
            + CLOSE_BASE_PAYLOAD + CLOSE_PLAYER_PAYLOAD;
    static final String BROWSE_URL = BASE_URL + "/browse";
    static final String BROWSE_PLAYLIST_PAYLOAD = DEFAULT_BASE_PAYLOAD + SCREEN_PART_PAYLOAD + CLOSE_BASE_PAYLOAD
            + "\"browseId\":\"VL%s\"}";
    static final String BROWSE_CONTINUATION_PAYLOAD = DEFAULT_BASE_PAYLOAD + SCREEN_PART_PAYLOAD + CLOSE_BASE_PAYLOAD
            + "\"continuation\":\"%s\"}";
    static final String NEXT_URL = BASE_URL + "/next";
    static final String NEXT_PAYLOAD = DEFAULT_BASE_PAYLOAD + SCREEN_PART_PAYLOAD + CLOSE_BASE_PAYLOAD
            + "\"videoId\":\"%s\",\"playlistId\":\"%s\"}";
    ...
    static final String MUSIC_BASE_PAYLOAD = "{\"context\":{\"client\":{\"clientName\":\"" + MUSIC_CLIENT_NAME
            + "\",\"clientVersion\":\"" + MUSIC_CLIENT_VERSION + "\"}},";

    static final String MUSIC_SEARCH_URL = MUSIC_BASE_URL + "/search?key=" + MUSIC_INNERTUBE_API_KEY;
    static final String MUSIC_SEARCH_PAYLOAD = MUSIC_BASE_PAYLOAD
            + "\"query\":\"%s\",\"params\":\"Eg-KAQwIARAAGAAgACgAMABqChADEAQQCRAFEAo=\"}";
